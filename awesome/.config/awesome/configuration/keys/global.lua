...
local globalKeys =
  ...
  awful.key({modkey, 'Control'}, 'b', 
    function() awful.util.spawn_with_shell(apps.default.change_background) end,
    {description = 'change background', group = 'quan'}),
  awful.key({modkey}, 'p', 
    function() xrandr.xrandr() end,
    {description = 'switch screen', group = 'quan'}),
  ...
  awful.key( {modkey}, 's',
    function() _G.awesome.spawn(apps.default.rofi) end,
    {description = 'show main menu', group = 'awesome'}
  ),
  -- Tag browsing
  ...
  awful.key({modkey}, 'e',
    function() awful.util.spawn_with_shell(apps.default.files) end,
    {description = 'Open files system', group = 'client'}
  ),
  awful.key({modkey}, 'k',
  ...
  awful.key({altkey}, 'Tab',
   ...
   --Programms
  awful.key({modkey}, '\\',
    function() awful.util.spawn_with_shell(apps.default.lock) end,
    {description = 'Lock the screen', group = 'awesome'}
  ),
  awful.key({modkey, 'Shift'}, 's',
    function() awful.util.spawn_with_shell(apps.default.flameshot_area) end,
    {description = 'Mark an area and screenshot', group = 'screenshots (clipboard)'}
  ),
  awful.key({modkey, 'Shift'}, 'a',
    function() awful.util.spawn_with_shell(apps.default.flameshot_full) end,
