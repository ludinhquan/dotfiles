local LSP = {
  ...
  NvimTreeNormal = { fg = C.fg, bg = Config.transparent_background and "NONE" or C.bg },
  ...
  BufferCurrent = { fg = C.fg, bg = C.ui_blue },
  BufferCurrentIndex = { fg = C.fg, bg = C.bg },
  BufferCurrentMod = { fg = C.info_yellow, bg = C.ui_blue },
  BufferCurrentSign = { fg = C.white, bg = C.ui_blue },
